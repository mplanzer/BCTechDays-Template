    ...
    begin
        ...
        if AOAIOperationResponse.IsSuccess() then begin
            if AOAIOperationResponse.IsFunctionCall() then begin
                ...
                foreach functionResponse in AOAIFunctionResponses do begin
                    if functionResponse.IsSuccess() then
                        Result := functionResponse.GetResult()
                    else
                        Error(functionResponse.GetError());
                end;
            end;
        end else
