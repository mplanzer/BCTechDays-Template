...
codeunit 50104 "Order Copilot Install"
{
    ...
    begin
        if not CopilotCapability.IsCapabilityRegistered(Enum::"Copilot Capability"::"Order Copilot") then
            CopilotCapability.RegisterCapability(Enum::"Copilot Capability"::"Order Copilot", Enum::"Copilot Availability"::Preview, Enum::"Copilot Billing Type"::"Undefined", LearnMoreUrlTxt);
    end;
